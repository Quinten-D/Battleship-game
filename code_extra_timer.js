...
function checkHit(coordinates,states,row,col){
  ...
  previousPreviousHitA=previousHitA;

    //deleteCountDown();

  //alert("prevprev="+ previousPreviousHitA );
  ...
  if (states==statesB) {
    ...
    if (B[row][col]!=0) {
      ...
      previousHitA=1;
      t=10;
      if (previousPreviousHitA==1) {
        clearInterval(countDown2);
        deleteCountDown();
      }
      createCountDown();
      countDown2 = setInterval(countDown,1000);
    }
  }
  if ((previousHitA==0) && (previousPreviousHitA==1)) {
    //alert("a");
    clearInterval(countDown2);
    deleteCountDown();
  }
